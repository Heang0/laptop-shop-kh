...
export class ProductService {
  private allProducts: Product[] = [
    ...
    { id: 'p15b', name: 'HP Omen 45L', brand: 'HP', price: 1899, img: 'https://images.unsplash.com/photo-1515879218367-8466d910aaa4?auto=format&fit=crop&w=800&q=70', rating: 4.6, category: 'Desktop' },
    { id: 'p15c', name: 'Alienware Aurora R16', brand: 'Dell', price: 2199, img: 'https://images.unsplash.com/photo-1518779578993-ec3579fee39f?auto=format&fit=crop&w=800&q=70', rating: 4.6, category: 'Desktop' },
    { id: 'p15d', name: 'Mini PC Pro', brand: 'Beelink', price: 479, img: 'https://images.unsplash.com/photo-1516387938699-a93567ec168e?auto=format&fit=crop&w=800&q=70', rating: 4.3, category: 'Desktop' },
    ...
    { id: 'p18b', name: 'iPad Air', brand: 'Apple', price: 699, img: 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?auto=format&fit=crop&w=800&q=70', rating: 4.6, category: 'Tablet' },
    { id: 'p18c', name: 'Galaxy Tab A9', brand: 'Samsung', price: 399, img: 'https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?auto=format&fit=crop&w=800&q=70', rating: 4.4, category: 'Tablet' },
    { id: 'p18d', name: 'Lenovo Tab P11', brand: 'Lenovo', price: 329, img: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=800&q=70', rating: 4.3, category: 'Tablet' },
